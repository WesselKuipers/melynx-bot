...
import { MelynxClient, type MelynxCommand } from '../types';
...
export const role: MelynxCommand = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName('remove-assignable-role')
  ...
  async execute(interaction, client) {
    ...
    if (subcommand === 'add-assignable-role') {
    ...
    if (subcommand === 'remove-assignable-role') {
      try {
  ...
  async componentExecute(interaction: RoleSelectMenuInteraction, client: MelynxClient) {
